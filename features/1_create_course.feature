Feature: Cadastro de Curso
  ...
  Scenario: TC-010 - Data início posterior à data fim
  ...
  Scenario: TC-011 - Formato de data inválido
  ...
  Scenario: TC-012 - Vagas não numérico
  ...
  Scenario: TC-013 - Vagas zero ou negativas
  ...
  Scenario: TC-014 - XSS em título e descrição
  ...
  Scenario: TC-015 - Click duplo / double submit
  ...
  Scenario: TC-016 - Backend 500 / timeout
    When o usuário preenche todos os campos com dados válidos
    And clica em "Salvar"
